...
async def handler(event):
    ...
    await client.send_message(chat,"""Hello there, Send me a link from zee5.com or mxplayer.in to download & upload to Telegram.
Visit my Developer at https://github.com/Nirmalraj10567  """)
